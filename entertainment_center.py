...
movies = [
	Movie(
		'Finding Nemo',
		('http://ia.media-imdb.com/images/M/MV5BMTY1MTg1NDAxOV5BMl5BanBnXkFtZT'
	...
	Movie(
		'Ride Along',
		('http://www.blackfilm.com/read/wp-content/uploads/2014/01/'
	...
	Movie(
		'Jurassic World',
		('http://ia.media-imdb.com/images/M/MV5BMTQ5MTE0MTk3Nl5BMl5BanBnXkFtZT'
			'gwMjczMzk2NTE@._V1_SX214_AL_.jpg'),
	...
	Movie(
		...
		('http://ia.media-imdb.com/images/M/MV5BNjE5ODg4NzY1MF5BMl5BanBnXkFtZT'
	...
	Movie(
		...
		('http://ia.media-imdb.com/images/M/MV5BMTk3ODgyMTgzNF5BMl5BanBnXkFtZT'
